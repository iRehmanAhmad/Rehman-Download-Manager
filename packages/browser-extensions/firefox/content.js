(function () {
  ...
  function injectDownloadButton(element, url) {
    ...
    button.style.cssText = [
      ...
      'width: 28px; height: 28px; background: #4f46e5; color: #fff; border-radius: 6px;',
      'display: flex; align-items: center; justify-content: center; cursor: pointer;',
      'font-size: 14px; line-height: 1; opacity: 0; transition: opacity 0.15s; pointer-events: auto;',
    ].join(' ');
